...
const Services = () => (
  <div>
    <Container text style={{ marginTop: '7em', marginBottom: '7em' }}>
        ...
        At TheRealCapstone, we not only provide complete analytics of all the current and future events, we also simplify it with our automated tools.
        ...
        <p style={{ fontSize: '1.33em', color: 'white'}}>
        TheRealCapstone understands that the fans are the core of every event, that is why we work directly with organizers for better accomodations.
        ...
        This becomes a reality of attending multiple events thanks to TheRealCapstone, you can assure that economics won't be a factor for unnatending.
        </p>
        <Grid.Column floated='right' width={10}>
        ...
        <p style={{ fontSize: '1.33em', color: 'white'}}>
        The future is bright for us here at TheRealCapstone, we plan on expanding throughout the whole nation so more people can have access to the benefits we provide.
